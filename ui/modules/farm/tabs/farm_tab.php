...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="ui/modules/farm/styles/tab_style.css">
    <script src="ui/modules/farm/scripts/tab_script.js"></script>
</head>
<body>
    <div class="top-toolbar">
        ...
        <a href="ui/modules/farm/pages/create_farm.php" class="add-button">Adicionar Fazenda</a>
    </div>
    
    <?php
    include('ui/modules/farm/tiles/farm_tile.php');
